...
private:
    ...
    Vector2d deltadot_tustin;
    Vector2d deltadot_tustin_old;
    ...
    Vector2d p_hat_old;
    Vector2d p_dot_hat;
    Vector2d p_dot_hat_old;
    Vector2d n_hat;
    Vector2d rhs_mob;
    Vector2d r;
    Vector2d forceExt_MOB_hat;
    Vector2d forceExt_MOB_hat_old;
    Vector2d forceExt_MOB_hat_old2;
...
public:
    ...
    void admittanceCtrl(StateModel_* state_model, double m, double b, double k, int flag, int flag_GRF);
    Vector2d DOBRW(StateModel_* state_model, double ko ,int flag);
    void FOBRW(StateModel_* state_model, double cut_off);
    void MOBRW(StateModel_* state_model, double ko); // MCL Intern Program by JihwanLee
