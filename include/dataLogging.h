...
void init_save_data()
{
    ...
    fprintf(fid, "t, ");
    fprintf(fid, "real_GRF, FOB_GRF, MOB_GRF, ");
...
void save_data(const mjModel* m, mjData* d, StateModel_* state_model, controller* controller)
{
    ...
    fprintf(fid, "%f, %f, %f, ", grf_r, state_model->GRF_FOB[0], state_model->GRF_MOB[0]);
